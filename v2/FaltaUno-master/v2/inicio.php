	...
	<div class="container-fluid main">
		<div class="row d-flex justify-content-around">
			<div class="col-lg-4 col-md-12 information">
					<h1>Bienvenido <?php echo $_SESSION["usuariologueado"];?> a  <strong>FaltaUno</strong>!</h1>
					<p>
					...
					<div>
						 <a href="register.html" class="btn btn-default" role="button"></a>
						  <a href="login.html" class="btn btn-default" role="button"></a>
					</div>
			</div>
